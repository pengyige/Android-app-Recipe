...
public class GetRecipe {
    ...
    public GetRecipe(String key, String menu, final SuccessCallback successCallback, final FailCallback failCallback)
    {
       new NetConnection(Config.URL_RECIPE,HttpMethod.POST,new NetConnection.SuccessCallback(){
           @Override
       ...
       },Config.KEY_KEY,key,Config.KEY_MENU,menu);
    }
